...
Regex catches `/Users/<name>/`. It does not catch things like `projects/acme-migration/phase-3`
...
`wiki.company.example.com`, `jira.internal.example`, `jenkins-prod-01.example.io`. Err on the
side of redacting.
